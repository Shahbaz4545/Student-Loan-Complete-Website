            ...
            <div class="mobile-screen">
                ...
                <nav class="mobile-view navbar-expand-md main-menu" id="menu-list">
                    <ul class="menu">            
                        ...
                        <li><a href="<?php echo $siteurl ?>./borrower-student">Borrower-Student</a></li>
                        <li><a class="btn btn_blue" href="<?php echo $siteurl ?>./contact"><i class="fal fa-phone-volume"></i> Contact Us</a></li>                       
                    </ul>  
                </nav>
            </div>
        </div>
